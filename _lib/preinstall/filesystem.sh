...
sgdisk -n ${PARTITION_BOOT_GRUB}:0:+550M ${INSTALL_DRIVE} # BOOT partition
...
mount -t vfat -o umask=0077 ${INSTALL_DRIVE}${PARTITION_BOOT_GRUB} ${MOUNT_PATH}${BOOT_SYSTEM_PARTITION}
}
